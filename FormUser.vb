Public Class FormUser
    ...
    Private Sub FormUser_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dgv.Columns.Clear()
        Call tampilData("select username2110024, nama2110024, password2110024, email2110024 from user2110024")
        Call setdgv()
        Call buatTombol()
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        perintah.Connection = kon
        perintah.CommandType = CommandType.Text
        perintah.CommandText = "update user2110024 set nama2110024='" & TextBox2.Text & "', password2110024=md5('" & TextBox3.Text & "'), email2110024 = '" & TextBox4.Text & "' where username2110024='" & TextBox1.Text & "'"
        perintah.ExecuteNonQuery()
        kon.Close()
        Call bersih()
        FormUser_Load(e, CType(AcceptButton, EventArgs))
        MsgBox("Data berhasil diupdate", MsgBoxStyle.Information, "Informasi")
    End Sub

    Private Sub TextBox5_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox5.TextChanged
        dgv.Columns.Clear()
        Call tampilData("select username2110024, nama2110024, password2110024, email2110024 from user2110024 where username2110024 like '%" & TextBox5.Text & "%' or nama2110024 like '%" & TextBox5.Text & "%' ")
        Call setdgv()
        Call buatTombol()
    End Sub
    ...
    Private Sub btnSimpan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSimpan.Click
        ...
        perintah.Connection = kon
        perintah.CommandType = CommandType.Text
        perintah.CommandText = "insert into user2110024(username2110024, nama2110024, password2110024,email2110024) values ('" & TextBox1.Text & "','" & TextBox2.Text & "',MD5('" & TextBox3.Text & "'),'" & TextBox4.Text & "')"
        perintah.ExecuteNonQuery()
        kon.Close()
        Call bersih()
        FormUser_Load(e, CType(AcceptButton, EventArgs))
    ...
    Private Sub TextBox1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TextBox1.KeyDown
        Select Case e.KeyCode
            Case Keys.Enter
                ...
                perintah.Connection = kon
                perintah.CommandType = CommandType.Text
                perintah.CommandText = "select * from user2110024 where username2110024 ='" & TextBox1.Text & "'"
    ...
    Private Sub dgv_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv.CellContentClick
        ...
        If e.ColumnIndex = 5 Then
            ...
            If x = vbYes Then
                ...
                perintah.Connection = kon
                perintah.CommandType = CommandType.Text
                perintah.CommandText = "delete from user2110024 where username2110024 = '" & id & "'"
                perintah.ExecuteNonQuery()
                kon.Close()
